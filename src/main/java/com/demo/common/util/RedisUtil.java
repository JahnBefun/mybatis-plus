...
public class RedisUtil {
    ...
    public boolean hasKey(String key){
        try {
            return stringRedisTemplate.hasKey(basePrefix+key);
        } catch (Exception e) {
    ...
    public boolean setExpire(String key, long time){
        try {
            if(time > 0){
                stringRedisTemplate.expire(basePrefix+key, time, TimeUnit.SECONDS);
            }
            return true;
        } catch (Exception e) {
    ...
    public long getExpire(String key){
        return stringRedisTemplate.getExpire(basePrefix+key,TimeUnit.SECONDS);
    }
    ...
    public void del(String... key){
        if(key != null && key.length > 0){
            if(key.length == 1){
                stringRedisTemplate.delete(basePrefix+key[0]);
            }else{
                List<String> keyArr = new ArrayList<>();
                for(String k:key){
                    keyArr.add(basePrefix+k);
                }
                stringRedisTemplate.delete(keyArr);
            }
        }
    }
    ...
    public <T> T get(String key,Class<T> clazz){
        try {
            String value = stringRedisTemplate.opsForValue().get(basePrefix+key);
    ...
    public long incrBy(String key, long delta){
        return stringRedisTemplate.opsForValue().increment(basePrefix+key, delta);
    }
    ...
    public Object hget(String key,String field){
        return stringRedisTemplate.opsForHash().get(basePrefix+key, field);
    }
    ...
    public Map<Object,Object> hmget(String key){
        return stringRedisTemplate.opsForHash().entries(basePrefix+key);
    }
    ...
    public boolean hmset(String key, Map<String,Object> map){
        try {
            stringRedisTemplate.opsForHash().putAll(basePrefix+key, map);
            return true;
        } catch (Exception e) {
    ...
    public boolean hset(String key,String field,String value) {
        try {
            stringRedisTemplate.opsForHash().put(basePrefix+key, field, value);
            return true;
        } catch (Exception e) {
    ...
    public void hdel(String key, String field){
        stringRedisTemplate.opsForHash().delete(basePrefix+key,field);
    }
    ...
    public boolean hHasKey(String key, String field){
        return stringRedisTemplate.opsForHash().hasKey(basePrefix+key, field);
    }
    ...
    public double hincr(String key, String field, double by){
        return stringRedisTemplate.opsForHash().increment(basePrefix+key, field, by);
    }
    ...
    public Set<String> sGet(String key){
        try {
            return stringRedisTemplate.opsForSet().members(basePrefix+key);
        } catch (Exception e) {
    ...
    public boolean sHasKey(String key,String value){
        try {
            return stringRedisTemplate.opsForSet().isMember(basePrefix+key, value);
        } catch (Exception e) {
    ...
    public long sSet(String key, String...values) {
        try {
            return stringRedisTemplate.opsForSet().add(basePrefix+key, values);
        } catch (Exception e) {
    ...
    public long sSetAndTime(String key,long time,String...values) {
        try {
            Long count = stringRedisTemplate.opsForSet().add(basePrefix+key, values);
            if(time>0) {
                setExpire(basePrefix+key, time);
            }
            return count;
    ...
    public long sGetSetSize(String key){
        try {
            return stringRedisTemplate.opsForSet().size(basePrefix+key);
        } catch (Exception e) {
    ...
    public long setRemove(String key, Object ...values) {
        try {
            Long count = stringRedisTemplate.opsForSet().remove(basePrefix+key, values);
            return count;
        } catch (Exception e) {
    ...
    public List<String> lGet(String key, long start, long end){
        try {
            return stringRedisTemplate.opsForList().range(basePrefix+key, start, end);
        } catch (Exception e) {
    ...
    public long lGetListSize(String key){
        try {
            return stringRedisTemplate.opsForList().size(basePrefix+key);
        } catch (Exception e) {
    ...
    public Object lGetIndex(String key,long index){
        try {
            return stringRedisTemplate.opsForList().index(basePrefix+key, index);
        } catch (Exception e) {
    ...
    public boolean lSet(String key, String value) {
        try {
            stringRedisTemplate.opsForList().rightPush(basePrefix+key, value);
            return true;
        } catch (Exception e) {
    ...
    public boolean lSet(String key, List<String> value) {
        try {
            stringRedisTemplate.opsForList().rightPushAll(basePrefix+key, value);
            return true;
        } catch (Exception e) {
    ...
    public boolean lUpdateIndex(String key, long index,String value) {
        try {
            stringRedisTemplate.opsForList().set(basePrefix+key, index, value);
            return true;
        } catch (Exception e) {
    ...
    public Long lRemove(String key,long count,String value) {
        try {
            return stringRedisTemplate.opsForList().remove(basePrefix+key, count, value);
        } catch (Exception e) {
